...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        sensor_binder_1 = BindDatapointsSensors.create(recipe_id=recipe_id, datapoints_id=datapoints_1_id, sensor_id=sensor_1.get_id())
        sensor_binder_2 = BindDatapointsSensors.create(recipe_id=recipe_id, datapoints_id=datapoints_1_id, sensor_id=sensor_2.get_id())
        sensor_binder_3 = BindDatapointsSensors.create(recipe_id=recipe_id, datapoints_id=datapoints_2_id, sensor_id=sensor_2.get_id())

        appliance_binder_1 = BindDatapointsAppliances.create(recipe_id=recipe_id, datapoints_id=datapoints_1_id, appliance_id=appliance_1.get_id(), polarity=1)
        appliance_binder_2 = BindDatapointsAppliances.create(recipe_id=recipe_id, datapoints_id=datapoints_1_id, appliance_id=appliance_2.get_id(), polarity=-1)
        appliance_binder_3 = BindDatapointsAppliances.create(recipe_id=recipe_id, datapoints_id=datapoints_2_id, appliance_id=appliance_3.get_id(), polarity=-1)
        appliance_binder_4 = BindDatapointsAppliances.create(recipe_id=recipe_id, datapoints_id=datapoints_2_id, appliance_id=appliance_4.get_id(), polarity=-1)
        appliance_binder_5 = BindDatapointsAppliances.create(recipe_id=recipe_id, datapoints_id=datapoints_2_id, appliance_id=appliance_5.get_id(), polarity=0)
