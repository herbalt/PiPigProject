...
with app.app_context():
    ...
    sensor_binder_1 = BindDatapointsSensors.create(recipe_id=1, datapoints_id=1, sensor_id=1)
    sensor_binder_2 = BindDatapointsSensors.create(recipe_id=1, datapoints_id=1, sensor_id=2)
    sensor_binder_3 = BindDatapointsSensors.create(recipe_id=1, datapoints_id=2, sensor_id=2)

    appliance_binder_1 = BindDatapointsAppliances.create(recipe_id=1, datapoints_id=1, appliance_id=1, polarity=1)
    appliance_binder_2 = BindDatapointsAppliances.create(recipe_id=1, datapoints_id=1, appliance_id=2, polarity=-1)
    appliance_binder_3 = BindDatapointsAppliances.create(recipe_id=1, datapoints_id=2, appliance_id=3, polarity=-1)
    appliance_binder_4 = BindDatapointsAppliances.create(recipe_id=1, datapoints_id=2, appliance_id=4, polarity=-1)
    appliance_binder_5 = BindDatapointsAppliances.create(recipe_id=1, datapoints_id=2, appliance_id=5, polarity=0)
